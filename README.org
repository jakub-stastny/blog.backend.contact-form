...
[[https://github.com/jakub-stastny/blog.backend.contact-form/actions/workflows/test.yml][https://github.com/jakub-stastny/blog.backend.contact-form/actions/workflows/test.yml/badge.svg]]
...
In case you're wondering where are all the Erlang files, you have to tangle code blocks from [[https://orgmode.org][Org mode]] files in =src= into actual Erlang files using Org mode in Emacs.
